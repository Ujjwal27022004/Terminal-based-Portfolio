...
import { createExperience } from "./commands/experience";
import { createSkills } from "./commands/skills";
import { createEducation } from "./commands/education";
import { createTimeline } from "./commands/timeline";
import { createContact } from "./commands/contact";
...
function commandHandler(input : string) {
  ...
  switch(input) {
    ...
    case 'experience':
      if (bareMode) {
        writeLines(["No data available.", "<br>"]);
        break;
      }
      writeLines(createExperience());
      break;
    case 'skills':
      if (bareMode) {
        writeLines(["No data available.", "<br>"]);
